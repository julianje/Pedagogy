...
setwd("~/Documents/Projects/Models/Pedagogy/Pedagogy/FinalData_TR/")
...
levels(data$ExploreProb)=c(".25 Exploration",".5 Exploration",".75 Exploration",".Exploration certainty")
